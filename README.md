...
[Charles Proxy](https://www.charlesproxy.com/documentation/welcome/) works as man in the middle.
It's a potential security risk. Therefore it should only be enabled on the dev api.

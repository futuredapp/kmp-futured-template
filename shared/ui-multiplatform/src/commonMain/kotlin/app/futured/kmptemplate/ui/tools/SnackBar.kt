...
class SnackbarHostState {
    ...
    private class SnackbarVisualsImpl(
        override val message: StringDesc,
        override val actionLabel: StringDesc?,
        ...
        if (actionLabel != null) {
            @Composable {
                TextButton(
                    ...
                    content = { Text(actionLabel.localized()) },
                )
            }
        } else {
            null
...
//                )
    ...
    Snackbar(
        ...
        content = { Text(snackbarData.visuals.message.localized()) },
    )
}

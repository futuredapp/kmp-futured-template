...
**Expected:** swiping left/right above horizontal pager scrolls between pager pages.
...
2. Tap **"Open Pager Screen"** — this pushes the pager screen onto a native `NavigationStack`.
3. Try to swipe horizontally to scroll pages left and right.

**Result on iOS 26:** the swipe dismisses the screen instead of changing pages in pager.
